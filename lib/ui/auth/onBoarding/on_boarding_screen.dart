...
import 'package:agora/ui/auth/onBoarding/on_boarding_cubit.dart';
...
class _OnBoardingScreenState extends State<OnBoardingScreen> {
  ...
  final List<String> _subtitlesList = [
    'On-boarding akışınızı saniyeler içinde oluşturun.',
    'Firebase kullanarak kullanıcı deneyimi',
    'Sorunlarınıza kolayca çözüm bulun',
    'hadi başlayalım'
  ];
