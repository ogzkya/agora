...
import 'package:agora/ui/auth/resetPasswordScreen/reset_password_screen.dart';
                ...
                listener: (context, state) {
                  ...
                  if (state.authState == AuthState.authenticated) {
                    ...
                    showSnackBar(context,
                        state.message ?? 'Giriş yapılamadı, Lütfen tekrar deneyin.');
                  }
                },
              ),
                ...
                listener: (context, state) {
                  if (state is ValidLoginFields) {
                    context.read<LoadingCubit>().showLoading(
                        context, 'Giriş yapılıyor, Lütfen bekleyin...', false);
